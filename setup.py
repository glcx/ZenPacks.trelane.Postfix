...
NAME = "ZenPacks.trelane.Postfix"
VERSION = "1.0.3"
AUTHOR = "Andrew D Kirch"
LICENSE = "GPLv2"
NAMESPACE_PACKAGES = ['ZenPacks', 'ZenPacks.trelane']
PACKAGES = ['ZenPacks', 'ZenPacks.trelane', 'ZenPacks.trelane.Postfix']
INSTALL_REQUIRES = []
COMPAT_ZENOSS_VERS = ""
PREV_ZENPACK_NAME = ""
# STOP_REPLACEMENTS
